...
let CommentsController = exports.CommentsController = class CommentsController {
    ...
    update(commentsId, updateCommentDto) {
...
__decorate([
    (0, common_1.Get)(':commentsId'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Param)('commentsId', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CommentsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':commentsId'),
    openapi.ApiResponse({ status: 200, type: String }),
    __param(0, (0, common_1.Param)('commentsId', common_1.ParseUUIDPipe)),
