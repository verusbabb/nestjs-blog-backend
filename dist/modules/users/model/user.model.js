...
const post_model_1 = require("../../posts/model/post.model");
const comment_model_1 = require("../../comments/model/comment.model");
const user_type_model_1 = require("../../user-types/model/user-type.model");
...
__decorate([
    sequelize_typescript_1.Column,
    (0, sequelize_typescript_1.ForeignKey)(() => user_type_model_1.UserType),
    __metadata("design:type", String)
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_type_model_1.UserType),
